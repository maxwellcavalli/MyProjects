...
<h:page ngApp="myApp" ngController="ProductSubGroupController as ctrl" >
	...
	<jsp:attribute name="scripts">
		...
		<script type="text/javascript" src="js/service/component_product_group_service.js"></script>
		<script type="text/javascript" src="js/controller/component_product_group_controller.js"></script>
	...
	<jsp:body>
		...
		<h:panel title="Product Sub Group Registration Form">
			...
			<form ng-submit="ctrl.submit()" name="formulario" class="form-horizontal" form-focus="true">
				 ...
				 <div class="row">
					<h:input model="ctrl.domain.product_sub_name" label="Name" name="name" form="formulario" maxlength="50" required="true" styleClass="col-md-10"/>
				</div>
					...
					<table class="col-sm-12 table-bordered table-striped table-condensed cf" style="padding-right: 0px; padding-left: 0px; ">
						...
						<tbody>
							...
							<tr ng-repeat="d in ctrl.datatable.data">
								...
								<td data-title="Name"><span ng-bind="d.product_sub_name"></span></td>
